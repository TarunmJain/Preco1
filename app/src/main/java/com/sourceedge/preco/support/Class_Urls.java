...
public class Class_Urls {
    ...
    public static final String Parent="http://clients1.sourceedge.com/preco/api/";
    public static final String Login=Parent+"Security/Login";
    ...
    public static final String SubmitOrder=Parent+"Services/SubmitOrder";
}
